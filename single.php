...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="entry-meta">
                <?php printf( '<span class="by-author">%s</span> %s <span class="in-category">%s</span>', get_the_author_link(), __( 'In', 'wpmedium' ), wpmedium_get_the_taxonomy_list( $wpmedium_options['general']['default_taxonomy'] ) ); ?> | <?php edit_post_link( __( 'Edit', 'wpmedium' ), '<span class="edit-link">', '</span>' ); ?>
              </div><!-- .entry-meta -->
